...
OUTPUT_PATH = os.path.join(DATA_PATH, "submission_roberta_base.csv")
MODEL_SAVE_PATH = os.path.join(DATA_PATH, "roberta_base_finetuned.pt")
LOG_PATH = os.path.join(DATA_PATH, "roberta_base_train_log.json")
